...
args[2]='SRR12168675.fasta.BLAST.Result.Last.txt_Downstream_Tags.csv'
...
write.table(Unique_Tags, paste(args[2], "_Unique_Raw_Downstream_Tags.csv", sep=""),row.names = F,quote = F,sep = ",")
write.csv(Unique_Tags, "UK36_Downstream_Unique_Tags.csv")
